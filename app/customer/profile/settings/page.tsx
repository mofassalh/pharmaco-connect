    ...
    <div className="min-h-screen bg-gray-50 pb-10">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-4">
        <div className="bg-white rounded-2xl border border-gray-100 p-5">
          <h3 className="font-bold text-gray-900 mb-4">ভাষা / Language</h3>
          <div className="flex gap-3">
            <button onClick={() => setLang("bn")} className={`flex-1 py-3 rounded-xl border-2 font-medium transition ${lang === "bn" ? "border-teal-400 bg-teal-50 text-teal-700" : "border-gray-200 text-gray-600"}`}>বাংলা</button>
            <button onClick={() => setLang("en")} className={`flex-1 py-3 rounded-xl border-2 font-medium transition ${lang === "en" ? "border-teal-400 bg-teal-50 text-teal-700" : "border-gray-200 text-gray-600"}`}>English</button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
          {[
            { href: "#", icon: "📍", label: "Delivery Addresses", sub: "২টি ঠিকানা সংরক্ষিত" },
            { href: "#", icon: "💳", label: "Saved Payment Methods", sub: "bKash, Nagad" },
            { href: "#", icon: "🔒", label: "Privacy & Security", sub: "Password পরিবর্তন" },
            { href: "#", icon: "💬", label: "Help & Support", sub: "সমস্যা জানান" },
          ].map((item, i) => (
